...
<section class="page-hero article-hero">
  <div class="container article-hero-grid">
    <div class="stack">
      ...
      <p class="article-meta"><span class="lang-pl-content">Autorka: Natalia Corvo · Opublikowano</span><span class="lang-en-content">Author: Natalia Corvo · Published</span> <time datetime="${meta.datePublished}">${datePl}</time> · <span class="lang-pl-content">Aktualizacja</span><span class="lang-en-content">Updated</span> <time datetime="${meta.dateModified}">${modifiedPl}</time></p>
    </div>
...
function renderBlogCard(source, cover) {
  const { meta } = source;
  const datePl = formatDateShortPl(meta.datePublished);
  const dateEn = formatDateShortEn(meta.datePublished);
