...
const htmlFiles = [
  ...
  ...[
    "bialko-w-diecie",
    "dieta-bezglutenowa-kiedy-stosowac",
    "dieta-dash-cisnienie-serce",
    "dieta-ketogeniczna-fakty-ryzyka",
    "dieta-przeciwzapalna-fakty",
    "dieta-przy-pracy-biurowej",
    "dieta-srodziemnomorska-praktycznie",
    "dieta-weganska-zbilansowana",
    "insulinoopornosc-dieta-nawyki",
    "jelita-mikrobiota-trawienie",
    "odchudzanie-bez-efektu-jojo",
    "planowanie-posilkow-brak-czasu",
    "post-przerywany-dla-kogo",
    "slodycze-zachcianki-emocjonalne-jedzenie",
    "talerz-zdrowego-zywienia",
    "zdrowe-odzywianie-bez-restrykcji",
    "zdrowe-sniadania-proste-pomysly",
  ].map((slug) => `articles/${slug}.html`),
];
